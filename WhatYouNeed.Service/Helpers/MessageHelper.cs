...
namespace Appli.Service
{
    public static class MessageHelper
    {
        public static MessageReadStateService MessageReadStateService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Appli.Service.MessageReadStateService>();
            }
        }
        ...
        public static MessageService MessageService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Appli.Service.MessageService>();
            }
        }
        ...
        public static MessageThreadService MessageThreadService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Appli.Service.MessageThreadService>();
            }
        }
        ...
        public static MessageParticipantService MessageParticipantService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<Appli.Service.MessageParticipantService>();
            }
        }
