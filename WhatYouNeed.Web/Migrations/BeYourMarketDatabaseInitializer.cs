...
namespace WhatYouNeed.Web.Migrations
{
    public class AppliDatabaseInitializer : CreateAndMigrateDatabaseInitializer<WhatYouNeed.Model.Models.AppliContext, ConfigurationInstall<WhatYouNeed.Model.Models.AppliContext>>
    {
        ...
        public AppliDatabaseInitializer(InstallModel installModel)
            : base()
        {
            _installModel = installModel;
            InitializeDatabase(new Model.Models.AppliContext());
        }
        #endregion

        #region Methods
        protected override void Seed(WhatYouNeed.Model.Models.AppliContext context)
        {
        ...
        private void InstallSettings(WhatYouNeed.Model.Models.AppliContext context)
        {
            if (_installModel.InstallSampleData)
            {
            ...
            else
            {
                context.Settings.Add(new Model.Models.Setting()
                {
                    ...
                    EmailContact = "hello@WhatYouNeed.com",
                    Version = "1.0",
                    Currency = "DKK",
                    TransactionFeePercent = 1,
                    TransactionMinimumSize = 10,
        ...
        private void InstallEmailTemplates(WhatYouNeed.Model.Models.AppliContext context)
        {
        ...
        private void InstallSampleData(WhatYouNeed.Model.Models.AppliContext context, ApplicationUser user)
        {
            context.Listings.Add(new Model.Models.Listing()
            {
                ...
                Currency = "DKK",
                ContactName = "Celia",
                ContactEmail = "demo@WhatYouNeed.com",
        ...
        private void InstallListingTypes(Model.Models.AppliContext context)
        {
            context.ListingTypes.Add(new WhatYouNeed.Model.Models.ListingType()
            {
                Name = "Offer",
                ButtonLabel = "Book",
        ...
        private void InstallCategories(Model.Models.AppliContext context)
        {
        ...
        private void InstallCategoryTypes(Model.Models.AppliContext context)
        {
            context.CategoryListingTypes.Add(new WhatYouNeed.Model.Models.CategoryListingType()
            {
                CategoryID = 1,
                ListingTypeID = 1,
                ObjectState = Repository.Pattern.Infrastructure.ObjectState.Added
        ...
        private void InstallPictures(Model.Models.AppliContext context)
        {
            for (int i = 1; i <= 9; i++)
            {
        ...
        //private void InstallStripe(Model.Models.AppliContext context)
        //{
        ...
        private void InstallDisqus(Model.Models.AppliContext context)
        {
            context.SettingDictionaries.Add(new Model.Models.SettingDictionary()
            {
                SettingID = 1,
