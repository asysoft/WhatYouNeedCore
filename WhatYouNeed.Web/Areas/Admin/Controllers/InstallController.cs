    ...
    public class InstallController : Controller
    {
        ...
        public ActionResult CheckAndInstall(InstallModel model)
        {
            ...
            switch ((DatabaseType)model.DatabaseType)
            {
                ...
                default:
                    string databaseFileName = string.Format("Appli_{0}.sdf", DateTime.Now.ToString("yyyy.MM.dd.HH.mm.ss"));
        ...
        {
            System.Data.Entity.Database.SetInitializer(new AppliDatabaseInitializer(model));

            // initialize and create database
            using (var context = new Model.Models.AppliContext())
            {
